...
class Attendance(models.Model):
    ...
    employee = models.ForeignKey(UsesDB,null=True, blank=True, on_delete=models.CASCADE, related_name='attendances')
    date = models.DateField()
    
    # Morning attendance
    morning_status = models.CharField(null=True, blank=True,max_length=20, choices=STATUS_CHOICES, default='absent')
    ...
    afternoon_status = models.CharField(null=True, blank=True,max_length=20, choices=STATUS_CHOICES, default='absent')
    ...
    # Daily summary
    total_working_hours = models.DecimalField(null=True, blank=True,max_digits=5, decimal_places=2, default=0)
    ...
    total_hours = models.DecimalField(null=True, blank=True,max_digits=5, decimal_places=2)
    reason = models.TextField(null=True, blank=True,)
    status = models.CharField(null=True, blank=True,max_length=20, choices=OTSTATUS_CHOICES, default='pending')
    approved_by = models.ForeignKey(UsesDB, on_delete=models.SET_NULL, null=True, blank=True)
